...
apigClientFactory.newClient = function (config) {
    ...
    var endpoint = 'https://7rbc7mm9g4.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.expensePost = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(expensePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.expenseOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var expenseOptionsRequest = {
